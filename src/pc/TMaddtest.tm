...
<machine name="test" tapes="1" xml-version="3">
    ...
    <state final="no" height="50" id="4" start="no" width="50" x="270" y="180">
        <name>q3</name>
    </state>
    <state final="no" height="50" id="5" start="no" width="50" x="150" y="50">
        <name>q4</name>
    </state>
    <state final="no" height="50" id="6" start="no" width="50" x="470" y="80">
        <name>q5</name>
    </state>
    <state final="yes" height="50" id="7" start="no" width="50" x="300" y="160">
        <name>qF</name>
    </state>
    <edge from="0" to="1">
        <transition id="0">
